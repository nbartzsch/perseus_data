...
#############################################################################
# Import data
processed_data_sens_1 <- read_csv(here("data", "processed_data/Medusa_01/second_firing", "filtered_signal_2.csv"))
processed_data_sens <- read_csv(here("data", "processed_data/Medusa_01/second_firing", "filtered_signal_1.csv"))
...
![](png_plots/Medusa_01/second_firing/response_time_01.svg){fig-align="center" width="500"}

![](png_plots/Medusa_01/second_firing/response_time_02.svg){fig-align="center" width="500"}
...
![](png_plots/Medusa_01/second_firing/stft_01.svg){fig-align="center" width="500"}

![](png_plots/Medusa_01/second_firing/stft_02.svg){fig-align="center" width="500"}
...
@fig-resp-1 shows a section of the filtered signal over 1 ms. We can determine the period $T$ of the signal to be $T \approx 0.069$ ms which translates to a frequency of $f = \frac{1}{T} \approx 14.5$ kHz. The responses of both sensors are shown in the plot.

```{r}
#| label: fig-resp-1
#| fig-cap: "Segment of sensor signal during 1 ms whit some phase bewtween both signals"
lower_time <- 4.10252 # 4.2535, 4.3678, 4.3126, 4.00469, 4.26432
...
Other sections, like the one in @fig-resp-2, show zero phase.

```{r}
#| label: fig-resp-2
#| fig-cap: "Segment of sensor signal during 1 ms with no phase shift"
lower_time <- 4.260702 # 4.146, 4.260715
upper_time <- lower_time + 0.001
...
```{r}
#| label: fig-resp-3
#| fig-cap: "Whole sensor response of the 'stable' section of the firing"
