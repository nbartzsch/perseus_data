...
subtitle: "Fourth Firing - Detonation Setpoint"
date: 02.12.2024
author:
  - name: PERSEUS
    affiliation: 
...
#############################################################################
# Import data
processed_data_sens_1 <- read_csv(here("data", "processed_data/Medusa_02/detonation/firing_04", "filtered_signal_2.csv"))
processed_data_sens <- read_csv(here("data", "processed_data/Medusa_02/detonation/firing_04", "filtered_signal_1.csv"))
...
![](png_plots/Medusa_02/detonation/firing_04/response_time_01.svg){fig-align="center" width="500"}

![](png_plots/Medusa_02/detonation/firing_04/response_time_02.svg){fig-align="center" width="500"}
...
![](png_plots/Medusa_02/detonation/firing_04/stft_01.svg){fig-align="center" width="500"}

![](png_plots/Medusa_02/detonation/firing_04/stft_02.svg){fig-align="center" width="500"}
