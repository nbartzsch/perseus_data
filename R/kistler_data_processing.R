...
raw_data_sens <- read.csv('data/raw_data/Medusa_01_0_001.csv')
...
write_csv(processed_data_sens, "data/processed_data/Medusa_01/first_firing/Medusa_01_01_complete.csv")
