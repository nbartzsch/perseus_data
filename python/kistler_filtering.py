...
file_path = os.path.join(
    current_directory,
    "data/processed_data/Medusa_02/deflagration/firing_02/Medusa_02_deflagration_02_complete.csv",
)
...
b_1_low, a_1_low = butter(
    order_1, normalized_cutoff_freq_low, btype="low", analog=False, output="ba"
)

# Design the Butterworth high-pass filter
b_1_high, a_1_high = butter(
    order_1, normalized_cutoff_freq_high, btype="high", analog=False, output="ba"
)
